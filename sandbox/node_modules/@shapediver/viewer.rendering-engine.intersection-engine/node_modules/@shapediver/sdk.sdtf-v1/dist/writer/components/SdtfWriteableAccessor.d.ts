...
export declare class SdtfWriteableAccessor extends SdtfBaseWriteableComponent implements ISdtfWriteableAccessor {
    bufferView?: ISdtfWriteableBufferView;
    id?: string;
    additionalProperties: Record<string, unknown>;
    static clone(original: ISdtfWriteableAccessor): ISdtfWriteableAccessor;
}
//# sourceMappingURL=SdtfWriteableAccessor.d.ts.map