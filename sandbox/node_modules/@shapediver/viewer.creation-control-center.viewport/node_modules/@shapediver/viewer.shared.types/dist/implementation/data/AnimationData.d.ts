...
export declare class AnimationData extends AbstractTreeNodeData implements IAnimationData {
    #private;
    /**
     ...
     * @param id the id
     */
    constructor(name: string, tracks: IAnimationTrack[], start: number, duration: number, id?: string, version?: string);
    get animate(): boolean;
    ...
    get start(): number;
    get tracks(): IAnimationTrack[];
    set tracks(value: IAnimationTrack[]);
    /**
