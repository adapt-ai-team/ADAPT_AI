            ...
            if (gltfLength < binaryGeometry.byteLength) {
                ...
                const header = {
                    magic: String.fromCharCode(headerDataView.getUint8(0)) +
                        ...
                        String.fromCharCode(headerDataView.getUint8(4)),
                ...
                this._body = binaryGeometry.slice(gltfLength +
                    this.BINARY_EXTENSION_HEADER_LENGTH +
                    1 +
                    header.contentLength, gltfLength + header.length);
            }
            else {
            ...
            for (let i = 0; i < count; i++) {
                ...
                for (let iy = 0; iy <= heightSegments; iy++) {
                    ...
                    for (let ix = 0; ix <= widthSegments; ix++) {
                        ...
                        // vertex
                        const vertex = gl_matrix_1.vec3.fromValues(-sphereRadius *
                            Math.cos(phiStart + u * phiLength) *
                            Math.sin(thetaStart + v * thetaLength), sphereRadius * Math.cos(thetaStart + v * thetaLength), sphereRadius *
