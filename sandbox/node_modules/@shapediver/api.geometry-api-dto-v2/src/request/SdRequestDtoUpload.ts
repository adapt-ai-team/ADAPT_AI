 ...
 * @swagger {components.schemas} RequestFileUpload {
     "description": "Body of a file upload request.<br/>A directory of file-parameter-IDs and upload-definitions.",
     "type": "object",
 ...
 */
/** Body of a file upload request.<br/>A directory of file-parameter-IDs and upload-definitions. */
