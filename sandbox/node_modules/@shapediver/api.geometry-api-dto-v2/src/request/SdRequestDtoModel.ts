...
export enum ShapeDiverRequestModelFiletype {
...
export enum ShapeDiverRequestModelTrustlevel {
    UNDEFINED = '',
    NONE = 'none',
    FULL = 'full',
}
...
export interface ShapeDiverRequestModel {
    ...
    /**
     * @swagger {components.schemas.RequestModel.properties} org_id {
    ...
    /**
     * @swagger {components.schemas.RequestModel.properties} user_id {
...
export type ShapeDiverRequestParameterDefinitionPart = {
    ...
    /**
     * @swagger {components.schemas.RequestParameterDefinitionPart.properties} group {
         "anyOf": [
           { "$ref": "#/components/schemas/RequestParameterDefinitionGroup" },
           { "$ref": "#/components/schemas/NullObject" },
           {
             "description": "Set to <code>null</code> to remove the parameter from the currently assigned group.",
             "type": "null"
           }
         ]
       }
     ...
     */
    group?: ShapeDiverRequestParameterDefinitionGroup | ShapeDiverNullObject | null;
    ...
    /**
     * @swagger {components.schemas.RequestParameterDefinitionPart.properties} settings {
...
/**
 * @swagger {components.schemas} RequestParameterDefinitionGroup {
     "allOf": [
 ...
 */
/** Group information of a parameter definition. */
