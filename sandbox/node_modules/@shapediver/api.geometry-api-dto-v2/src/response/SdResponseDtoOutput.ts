...
export interface ShapeDiverResponseOutputContent {
     ...
     * @swagger {components.schemas.ResponseOutputContent.properties} msg {
         "description": "This was used by legacy <code>transform_content_array</code> in case of an error in getting texture URLs.",
         "type": "string"
       }
     */
    /** This was used by legacy <code>transform_content_array</code> in case of an error in getting texture URLs. */
    msg?: string;
