    ...
    loadContent(content) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!content) {
                ...
                throw this._logger.handleError(viewer_shared_services_1.LOGGINGTOPIC.DATA_PROCESSING, `MaterialEngine.loadContent`, error);
            }
            ...
            if (content.data) {
                ...
                if (data.materialpreset)
                    yield this.loadPresetMaterial(data.materialpreset, material);
                if (data.materialType && data.materialType !== 'standard') {
                    ...
                    if (data.version) {
                        if (data.version === '1.0') {
                            yield this.loadMaterialV1(data, material);
                        }
                        else if (data.version === '2.0') {
                            yield this.loadMaterialV2(data, material);
                        }
                        else if (data.version === '3.0') {
                            yield this.loadMaterialV3(data, material);
                        }
                        else {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                if (e instanceof viewer_shared_services_1.ShapeDiverViewerError || e instanceof viewer_shared_services_1.ShapeDiverBackendError)
                    throw e;
                throw this._logger.handleError(viewer_shared_services_1.LOGGINGTOPIC.DATA_PROCESSING, `MaterialEngine.loadMap`, e);
            }
    ...
    loadMapWithProperties(texture) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                if (e instanceof viewer_shared_services_1.ShapeDiverViewerError || e instanceof viewer_shared_services_1.ShapeDiverBackendError)
                    throw e;
                throw this._logger.handleError(viewer_shared_services_1.LOGGINGTOPIC.DATA_PROCESSING, `MaterialEngine.loadMapWithProperties`, e);
            }
