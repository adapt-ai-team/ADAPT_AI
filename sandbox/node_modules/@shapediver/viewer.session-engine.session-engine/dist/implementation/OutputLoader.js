...
class OutputLoader {
     ...
     */
    loadOutputs(responseDto, outputs, outputsFreeze, cancelRequest = () => false) {
        var _a, _b;
        return __awaiter(this, void 0, void 0, function* () {
            this._performanceEvaluator.startSection('outputLoading');
            const node = new SessionTreeNode_1.SessionTreeNode((_a = responseDto.model) === null || _a === void 0 ? void 0 : _a.name);
            let currentNodes = {};
            let promises = [];
            let promisesNodes = [];
            let maxDelay = 0;
            ...
            if (cancelRequest())
                return new SessionTreeNode_1.SessionTreeNode((_b = responseDto.model) === null || _b === void 0 ? void 0 : _b.name);
