...
exports.validate = exports.sessionSettingsSchema = exports.renderingSettingsSchema = exports.postProcessingSettingsSchema = exports.lightSettingsSchema = exports.generalSettingsSchema = exports.environmentGeometrySettingsSchema = exports.environmentSettingsSchema = exports.cameraSettingsSchema = exports.arSettingsSchema = exports.postProcessingSchema = exports.lightSchema = exports.cameraSchema = void 0;
...
exports.cameraSchema = zod_1.z.record(zod_1.z.union([perspectiveCameraSchema, generalCameraSchema]));
...
exports.lightSchema = zod_1.z.record(zod_1.z.object({
    name: zod_1.z.string().optional(),
...
exports.lightSettingsSchema = zod_1.z.object({
    lightSceneId: zod_1.z.string().optional(),
    lightScenes: exports.lightSchema,
});
exports.postProcessingSettingsSchema = zod_1.z.object({
    ...
    effects: exports.postProcessingSchema
});
exports.renderingSettingsSchema = zod_1.z.object({
...
exports.sessionSettingsSchema = zod_1.z.record(zod_1.z.object({
    order: zod_1.z.number().optional(),
...
const schema = zod_1.z.object({
    ...
    ar: exports.arSettingsSchema,
    camera: exports.cameraSettingsSchema,
    environment: exports.environmentSettingsSchema,
    environmentGeometry: exports.environmentGeometrySettingsSchema,
    general: exports.generalSettingsSchema,
    light: exports.lightSettingsSchema,
    postprocessing: exports.postProcessingSettingsSchema,
    rendering: exports.renderingSettingsSchema,
    session: exports.sessionSettingsSchema,
}).strict();
const validate = (s) => {
