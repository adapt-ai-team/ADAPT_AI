    ...
    loadContent(content) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                if (content.format === 'tag2d') {
                    ...
                    data.forEach((element) => {
                        ...
                        if (!element.location || !element.text) {
                            this._logger.warn(viewer_shared_services_1.LOGGINGTOPIC.DATA_PROCESSING, 'HTMLElementAnchorEngine.load: One of the specified Tag2D elements did not have all necessary properties.');
                            return;
                        }
                    ...
                    data.forEach((element) => {
                        if (!element.location || !element.data) {
                            this._logger.warn(viewer_shared_services_1.LOGGINGTOPIC.DATA_PROCESSING, 'HTMLElementAnchorEngine.load: One of the specified Anchor elements did not have all necessary properties.');
                            return;
                        }
                        let position;
                        ...
                        if (!element.format || (element.format === 'text')) {
                            if (!element.data.text) {
                                this._logger.warn(viewer_shared_services_1.LOGGINGTOPIC.DATA_PROCESSING, 'HTMLElementAnchorEngine.load: The text property for an Anchor element is missing.');
                                return;
                            }
                        ...
                        this._logger.warn(viewer_shared_services_1.LOGGINGTOPIC.DATA_PROCESSING, `HTMLElementAnchorEngine.load: The Anchor does not have a recognized format: ${element.format}`);
                    });
                }
                return node;
            }
                ...
                throw this._logger.handleError(viewer_shared_services_1.LOGGINGTOPIC.DATA_PROCESSING, `HTMLElementAnchorEngine.load`, error);
            }
        });
    }
};
