...
class ShapeDiverViewerCustomizationError extends ShapeDiverError_1.ShapeDiverViewerError {
    constructor(message, errorObject) {
        super(ShapeDiverError_1.ShapeDiverViewerErrorType.CUSTOMIZATION_ERROR, "An error occurred while customizing the session.", message);
        this.message = message;
        this.errorObject = errorObject;
    }
}
exports.ShapeDiverViewerCustomizationError = ShapeDiverViewerCustomizationError;
