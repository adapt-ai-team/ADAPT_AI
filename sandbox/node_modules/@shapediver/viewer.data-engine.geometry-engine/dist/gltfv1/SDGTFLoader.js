        ...
        return __awaiter(this, void 0, void 0, function* () {
            if (gltfLength < binaryGeometry.byteLength) {
                ...
                if (header.magic != 'sdgTF') {
                    ...
                    throw this._logger.handleError(viewer_shared_services_1.LOGGINGTOPIC.DATA_PROCESSING, `SDGTFLoader.load`, error);
                }
                // create content
            ...
            try {
                ...
                throw this._logger.handleError(viewer_shared_services_1.LOGGINGTOPIC.DATA_PROCESSING, `SDGTFLoader.load`, e);
            }
        });
    }
    ...
    loadArcs() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            for (let i = 0; i < count; ++i) {
                ...
                if (arcRadius <= 0) {
                    this._logger.warn(viewer_shared_services_1.LOGGINGTOPIC.DATA_PROCESSING, 'SDGTFLoader.loadArcs: Arc radius is <= 0.');
                    continue;
                }
                const points = [];
    ...
    loadCircles() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            for (let i = 0; i < count; i++) {
                ...
                if (circleRadius <= 0) {
                    this._logger.warn(viewer_shared_services_1.LOGGINGTOPIC.DATA_PROCESSING, 'SDGTFLoader.loadCircles: Circle radius is <= 0.');
                    continue;
                }
                const points = [];
                const getPointOnArc = (t) => {
    ...
    loadCylinders() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            for (let i = 0; i < count; i++) {
                ...
                if (cylinderRadius <= 0) {
                    this._logger.warn(viewer_shared_services_1.LOGGINGTOPIC.DATA_PROCESSING, 'SDGTFLoader.loadCylinders: Cylinder radius is <= 0.');
                    continue;
                }
                const indices = [];
                const vertices = [];
    ...
    loadSpheres() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            for (let i = 0; i < count; i++) {
                ...
                if (sphereRadius <= 0) {
                    this._logger.warn(viewer_shared_services_1.LOGGINGTOPIC.DATA_PROCESSING, 'SDGTFLoader.loadSpheres: Sphere radius is <= 0.');
                    continue;
                }
                const indices = [];
                const vertices = [];
