    ...
    loadContent(content) {
        return __awaiter(this, void 0, void 0, function* () {
            if (!content || (content && !content.href)) {
                ...
                throw this._logger.handleError(viewer_shared_services_1.LOGGINGTOPIC.DATA_PROCESSING, `GeometryEngine.loadContent`, error);
            }
            ...
            if (content.format === 'glb' || content.format === 'gltf') {
                ...
                try {
                    ...
                    throw this._logger.handleError(viewer_shared_services_1.LOGGINGTOPIC.DATA_PROCESSING, `GeometryEngine.loadContent`, e);
                }
                ...
                if (isBinary) {
                    ...
                    if (gltfContent && gltfContent.asset && gltfContent.asset.version) {
                        ...
                        this._logger.warn(viewer_shared_services_1.LOGGINGTOPIC.DATA_PROCESSING, 'GeometryEngine.loadContent: No version specified in asset, trying to load as v2.');
                        version = '2.0';
                    }
