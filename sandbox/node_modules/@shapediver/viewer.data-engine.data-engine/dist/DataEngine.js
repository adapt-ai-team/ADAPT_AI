    ...
    loadContent(content) {
        return __awaiter(this, void 0, void 0, function* () {
            if (!content || (content && !content.format)) {
                ...
                throw this._logger.handleError(viewer_shared_services_1.LOGGINGTOPIC.DATA_PROCESSING, `DataEngine.loadContent`, error);
            }
            try {
                let node;
                if (content.format === 'glb' || content.format === 'gltf') {
                    ...
                    node = yield this._sdtfEngine.loadContent(content);
                }
                else {
                ...
                throw this._logger.handleError(viewer_shared_services_1.LOGGINGTOPIC.DATA_PROCESSING, `DataEngine.loadContent`, e);
            }
        });
    }
};
