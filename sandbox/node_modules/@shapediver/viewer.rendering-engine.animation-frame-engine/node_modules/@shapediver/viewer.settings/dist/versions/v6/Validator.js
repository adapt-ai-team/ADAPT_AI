...
exports.generalSettingsSchema = zod_1.z.object({
    ...
    defaultMaterialColor: zod_1.z.string().optional(),
});
...
exports.environmentGeometrySettingsSchema = zod_1.z.object({
    ...
    contactShadowVisibility: zod_1.z.boolean().optional(),
    contactShadowOpacity: zod_1.z.number().optional(),
    contactShadowBlur: zod_1.z.number().optional(),
    contactShadowHeight: zod_1.z.number().optional(),
    contactShadowDarkness: zod_1.z.number().optional()
});
