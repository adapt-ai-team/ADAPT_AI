...
export declare class Output implements IOutput {
    ...
    triggerUpdateCallback(newNode?: TreeNode, oldNode?: TreeNode): Promise<void>;
    updateOutput(newNode?: TreeNode, oldNode?: TreeNode): void;
    updateOutputContent(outputContent: ShapeDiverResponseOutputContent[], preventUpdate?: boolean, waitForViewportUpdate?: boolean): Promise<ITreeNode | undefined>;
