...
let SettingsEngine = class SettingsEngine {
    constructor() {
        ...
        this._settings = viewer_settings_1.DefaultsV3_1();
    ...
    convertToTargetVersion() {
        return viewer_settings_1.convert(this._settings, this._settings_version);
    }
    flatten() {
    ...
    loadSettings(json, sessionId, loadAsPrimary = false) {
        if (JSON.stringify(json) !== JSON.stringify({})) {
            try {
                ...
                this._settings = viewer_settings_1.convert(json, '3.1');
            ...
            try {
                viewer_settings_1.validate(json, '3.1');
                this._settings_version = '3.1';
                this._settings = viewer_settings_1.convert(json, '3.1');
                this.cleanSettings(this._settings);
                return;
                ...
                const error = new ShapeDiverViewerErrors_1.ShapeDiverViewerSettingsError('SettingsEngine.loadSettings: Settings could not be validated.', e);
