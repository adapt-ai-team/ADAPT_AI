...
class ShapeDiverViewerGeneralError extends ShapeDiverError_1.ShapeDiverViewerError {
    constructor(message, errorObject) {
        super(ShapeDiverError_1.ShapeDiverViewerErrorType.GENERAL_VIEWER_ERROR, 'An error occurred while working with the viewer.', message);
        this.message = message;
        this.errorObject = errorObject;
    }
}
