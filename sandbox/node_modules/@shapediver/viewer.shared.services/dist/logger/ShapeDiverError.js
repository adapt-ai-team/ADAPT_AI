...
(function (ShapeDiverViewerErrorType) {
    ...
    ShapeDiverViewerErrorType["GENERAL_VIEWER_ERROR"] = "SdGeneralViewerError";
...
class ShapeDiverViewerError extends ShapeDiverError {
    // #region Constructors (1)
    constructor(error, desc, message) {
        super(message);
        this.error = error;
        this.desc = desc;
        this.error = (Object.values(ShapeDiverViewerErrorType).includes(error))
            ? error
            : ShapeDiverViewerErrorType.UNKNOWN;
    }
}
