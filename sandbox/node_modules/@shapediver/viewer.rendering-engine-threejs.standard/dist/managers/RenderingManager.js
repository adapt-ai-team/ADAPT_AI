...
class RenderingManager {
    ...
    addSpinner(canvas, branding) {
        ...
        (_a = canvas.parentElement) === null || _a === void 0 ? void 0 : _a.appendChild(spinnerDivElement);
    ...
    animate(time) {
        ...
        this._renderingEngine.renderer.shadowMap.enabled = this._renderingEngine.usingSwiftShader || this._renderingEngine.type === viewer_rendering_engine_rendering_engine_1.RENDERERTYPE.ATTRIBUTES ? false : this._renderingEngine.shadows;
        ...
        if (states.beautyRendering === true) {
            ...
            if (this._renderingEngine.beautyRenderingManager.beautyRenderingDurationActive >= this._renderingEngine.beautyRenderBlendingDuration) {
                this._eventEngine.emitEvent(viewer_shared_services_1.EVENTTYPE.RENDERING.BEAUTY_RENDERING_FINISHED, { viewerId: this._renderingEngine.id });
        ...
        try {
            ...
            if (_gl === null) {
                ...
                if (_gl !== null) {
                    ...
                    throw this._logger.handleError(viewer_shared_services_1.LOGGINGTOPIC.VIEWER, `RenderingLogic.createWebGLContext`, error, false);
                }
            }
    ...
    evaluateRenderingState() {
        ...
        if (this._renderingEngine.beautyRenderingManager.beautyRenderingActive === true && busyMode === false &&
            ...
            this._renderingEngine.usingSwiftShader === false && this._runningAnimation === false && this._renderingEngine.type !== viewer_rendering_engine_rendering_engine_1.RENDERERTYPE.ATTRIBUTES)
