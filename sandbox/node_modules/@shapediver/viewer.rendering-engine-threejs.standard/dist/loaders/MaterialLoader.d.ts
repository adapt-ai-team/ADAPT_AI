...
import { PRIMITIVE_MODE, AbstractMaterialData, MaterialUnlitData, MaterialSpecularGlossinessData, MaterialStandardData } from '@shapediver/viewer.shared.types';
...
export declare class MaterialLoader implements ILoader {
    ...
    init(): void;
    getMaterialProperties(materialData: AbstractMaterialData | MaterialUnlitData | MaterialSpecularGlossinessData | MaterialStandardData | null, type: MATERIAL_TYPE, materialSettings?: MaterialSettings): {
     ...
     */
    load(materialData: AbstractMaterialData | MaterialUnlitData | MaterialSpecularGlossinessData | MaterialStandardData | null, materialSettings?: MaterialSettings): THREE.Material;
