...
class LightScene {
    ...
    set name(value) {
        try {
            ...
            __classPrivateFieldGet(this, _LightScene_logger, "f").debug(viewer_shared_services_1.LOGGINGTOPIC.LIGHT, `LightScene(${this.id}).name: name was set to: ${value}`);
            ...
            if (e instanceof viewer_shared_services_1.ShapeDiverViewerError || e instanceof viewer_shared_services_1.ShapeDiverBackendError)
                throw e;
            throw __classPrivateFieldGet(this, _LightScene_logger, "f").handleError(viewer_shared_services_1.LOGGINGTOPIC.LIGHT, `Light(${this.id}).name`, e);
        }
    }
    get node() {
    ...
    addAmbientLight(properties) {
        try {
            ...
            __classPrivateFieldGet(this, _LightScene_logger, "f").debug(viewer_shared_services_1.LOGGINGTOPIC.LIGHT, `Viewer(${this.id}).addAmbientLight: Ambient light with id ${light.id} created.`);
            __classPrivateFieldGet(this, _LightScene_viewer, "f").update();
            return light;
        }
        catch (e) {
            if (e instanceof viewer_shared_services_1.ShapeDiverViewerError || e instanceof viewer_shared_services_1.ShapeDiverBackendError)
                throw e;
            throw __classPrivateFieldGet(this, _LightScene_logger, "f").handleError(viewer_shared_services_1.LOGGINGTOPIC.LIGHT, `Light(${this.id}).addAmbientLight`, e);
        }
    }
    /**
    ...
    addDirectionalLight(properties) {
        try {
            ...
            const light = this.lights[lightLogic.id];
            __classPrivateFieldGet(this, _LightScene_logger, "f").debug(viewer_shared_services_1.LOGGINGTOPIC.LIGHT, `Viewer(${this.id}).addDirectionalLight: Directional light with id ${light.id} created.`);
            __classPrivateFieldGet(this, _LightScene_viewer, "f").update();
            return light;
        }
        catch (e) {
            if (e instanceof viewer_shared_services_1.ShapeDiverViewerError || e instanceof viewer_shared_services_1.ShapeDiverBackendError)
                throw e;
            throw __classPrivateFieldGet(this, _LightScene_logger, "f").handleError(viewer_shared_services_1.LOGGINGTOPIC.LIGHT, `Light(${this.id}).addDirectionalLight`, e);
        }
    }
    /**
    ...
    addHemisphereLight(properties) {
        try {
            ...
            const light = this.lights[lightLogic.id];
            __classPrivateFieldGet(this, _LightScene_logger, "f").debug(viewer_shared_services_1.LOGGINGTOPIC.LIGHT, `Viewer(${this.id}).addHemisphereLight: Hemisphere light with id ${light.id} created.`);
            __classPrivateFieldGet(this, _LightScene_viewer, "f").update();
            return light;
        }
        catch (e) {
            if (e instanceof viewer_shared_services_1.ShapeDiverViewerError || e instanceof viewer_shared_services_1.ShapeDiverBackendError)
                throw e;
            throw __classPrivateFieldGet(this, _LightScene_logger, "f").handleError(viewer_shared_services_1.LOGGINGTOPIC.LIGHT, `Light(${this.id}).addHemisphereLight`, e);
        }
    }
    /**
    ...
    addPointLight(properties) {
        try {
            ...
            const light = this.lights[lightLogic.id];
            __classPrivateFieldGet(this, _LightScene_logger, "f").debug(viewer_shared_services_1.LOGGINGTOPIC.LIGHT, `Viewer(${this.id}).addPointLight: Point light with id ${light.id} created.`);
            __classPrivateFieldGet(this, _LightScene_viewer, "f").update();
            return light;
        }
        catch (e) {
            if (e instanceof viewer_shared_services_1.ShapeDiverViewerError || e instanceof viewer_shared_services_1.ShapeDiverBackendError)
                throw e;
            throw __classPrivateFieldGet(this, _LightScene_logger, "f").handleError(viewer_shared_services_1.LOGGINGTOPIC.LIGHT, `Light(${this.id}).addPointLight`, e);
        }
    }
    /**
    ...
    addSpotLight(properties) {
        try {
            ...
            const light = this.lights[lightLogic.id];
            __classPrivateFieldGet(this, _LightScene_logger, "f").debug(viewer_shared_services_1.LOGGINGTOPIC.LIGHT, `Viewer(${this.id}).addSpotLight: Spot light with id ${light.id} created.`);
            __classPrivateFieldGet(this, _LightScene_viewer, "f").update();
            return light;
        }
        catch (e) {
            if (e instanceof viewer_shared_services_1.ShapeDiverViewerError || e instanceof viewer_shared_services_1.ShapeDiverBackendError)
                throw e;
            throw __classPrivateFieldGet(this, _LightScene_logger, "f").handleError(viewer_shared_services_1.LOGGINGTOPIC.LIGHT, `Light(${this.id}).addSpotLight`, e);
        }
    }
    /**
    ...
    removeLight(id) {
        try {
            ...
            if (r)
                __classPrivateFieldGet(this, _LightScene_logger, "f").debug(viewer_shared_services_1.LOGGINGTOPIC.LIGHT, `Viewer(${this.id}).removeLight: Light with id ${id} removed.`);
            if (!r)
                __classPrivateFieldGet(this, _LightScene_logger, "f").debug(viewer_shared_services_1.LOGGINGTOPIC.LIGHT, `Viewer(${this.id}).removeLight: Could not remove light with id ${id}.`);
            __classPrivateFieldGet(this, _LightScene_viewer, "f").update();
            return r;
        }
        catch (e) {
            if (e instanceof viewer_shared_services_1.ShapeDiverViewerError || e instanceof viewer_shared_services_1.ShapeDiverBackendError)
                throw e;
            throw __classPrivateFieldGet(this, _LightScene_logger, "f").handleError(viewer_shared_services_1.LOGGINGTOPIC.LIGHT, `Light(${this.id}).removeLight`, e);
        }
    }
}
