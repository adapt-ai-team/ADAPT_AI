...
class HemisphereLight extends AbstractLight_1.AbstractLight {
    ...
    set groundColor(value) {
        try {
            ...
            __classPrivateFieldGet(this, _HemisphereLight_logger, "f").debug(viewer_shared_services_1.LOGGINGTOPIC.LIGHT, `Light(${this.id}).groundColor: groundColor was set to: ${value}`);
            ...
            if (e instanceof viewer_shared_services_1.ShapeDiverViewerError || e instanceof viewer_shared_services_1.ShapeDiverBackendError)
                throw e;
            throw __classPrivateFieldGet(this, _HemisphereLight_logger, "f").handleError(viewer_shared_services_1.LOGGINGTOPIC.LIGHT, `Light(${this.id}).groundColor`, e);
        }
    }
}
