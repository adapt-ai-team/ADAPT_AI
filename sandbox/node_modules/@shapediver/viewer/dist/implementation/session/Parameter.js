...
class Parameter {
    ...
    constructor(session, sessionEngine, paramDef) {
        ...
        try {
            ...
            if (__classPrivateFieldGet(this, _Parameter_type, "f") === PARAMETERTYPE.BOOL) {
                __classPrivateFieldSet(this, _Parameter_defaultValue, (__classPrivateFieldGet(this, _Parameter_defval, "f") === 'true'), "f");
            }
            else if (__classPrivateFieldGet(this, _Parameter_type, "f") === PARAMETERTYPE.EVEN || __classPrivateFieldGet(this, _Parameter_type, "f") === PARAMETERTYPE.FLOAT || __classPrivateFieldGet(this, _Parameter_type, "f") === PARAMETERTYPE.INT || __classPrivateFieldGet(this, _Parameter_type, "f") === PARAMETERTYPE.ODD) {
            ...
            if (e instanceof viewer_shared_services_1.ShapeDiverViewerError || e instanceof viewer_shared_services_1.ShapeDiverBackendError)
                throw e;
            throw __classPrivateFieldGet(this, _Parameter_logger, "f").handleError(viewer_shared_services_1.LOGGINGTOPIC.PARAMETER, `Parameter(${paramDef.id}).constructor`, e);
        }
    }
    ...
    set displayname(value) {
        try {
            ...
            __classPrivateFieldGet(this, _Parameter_logger, "f").debug(viewer_shared_services_1.LOGGINGTOPIC.PARAMETER, `Parameter(${__classPrivateFieldGet(this, _Parameter_id, "f")}).displayname: DisplayName was updated to ${this.displayname}.`);
        }
        catch (e) {
            if (e instanceof viewer_shared_services_1.ShapeDiverViewerError || e instanceof viewer_shared_services_1.ShapeDiverBackendError)
                throw e;
            throw __classPrivateFieldGet(this, _Parameter_logger, "f").handleError(viewer_shared_services_1.LOGGINGTOPIC.PARAMETER, `Parameter(${this.id}).displayname`, e);
        }
    }
    get expression() {
    ...
    set hidden(value) {
        try {
            ...
            __classPrivateFieldGet(this, _Parameter_logger, "f").debug(viewer_shared_services_1.LOGGINGTOPIC.PARAMETER, `Parameter(${__classPrivateFieldGet(this, _Parameter_id, "f")}).hidden: Hidden was updated to ${this.hidden}.`);
        }
        catch (e) {
            if (e instanceof viewer_shared_services_1.ShapeDiverViewerError || e instanceof viewer_shared_services_1.ShapeDiverBackendError)
                throw e;
            throw __classPrivateFieldGet(this, _Parameter_logger, "f").handleError(viewer_shared_services_1.LOGGINGTOPIC.PARAMETER, `Parameter(${this.id}).hidden`, e);
        }
    }
    get id() {
    ...
    set order(value) {
        try {
            ...
            __classPrivateFieldGet(this, _Parameter_logger, "f").debug(viewer_shared_services_1.LOGGINGTOPIC.PARAMETER, `Parameter(${__classPrivateFieldGet(this, _Parameter_id, "f")}).order: Order was updated to ${this.order}.`);
        }
        catch (e) {
            if (e instanceof viewer_shared_services_1.ShapeDiverViewerError || e instanceof viewer_shared_services_1.ShapeDiverBackendError)
                throw e;
            throw __classPrivateFieldGet(this, _Parameter_logger, "f").handleError(viewer_shared_services_1.LOGGINGTOPIC.PARAMETER, `Parameter(${this.id}).order`, e);
        }
    }
    get sessionValue() {
    ...
    set sessionValue(value) {
        try {
            ...
            if (this.isValid(value, true)) {
                ...
                __classPrivateFieldGet(this, _Parameter_logger, "f").debug(viewer_shared_services_1.LOGGINGTOPIC.PARAMETER, `Parameter(${__classPrivateFieldGet(this, _Parameter_id, "f")}).sessionValue: SessionValue was updated to ${this.value}.`);
            }
            else {
                const error = new viewer_shared_services_1.ShapeDiverViewerSessionError(`Parameter(${__classPrivateFieldGet(this, _Parameter_id, "f")}).sessionValue: Could not validate value.`);
                throw __classPrivateFieldGet(this, _Parameter_logger, "f").handleError(viewer_shared_services_1.LOGGINGTOPIC.PARAMETER, `Parameter(${this.id}).sessionValue`, error);
            }
        }
        catch (e) {
            if (e instanceof viewer_shared_services_1.ShapeDiverViewerError || e instanceof viewer_shared_services_1.ShapeDiverBackendError)
                throw e;
            throw __classPrivateFieldGet(this, _Parameter_logger, "f").handleError(viewer_shared_services_1.LOGGINGTOPIC.PARAMETER, `Parameter(${this.id}).sessionValue`, e);
        }
    }
    get structure() {
    ...
    set tooltip(value) {
        try {
            ...
            __classPrivateFieldGet(this, _Parameter_logger, "f").debug(viewer_shared_services_1.LOGGINGTOPIC.PARAMETER, `Parameter(${__classPrivateFieldGet(this, _Parameter_id, "f")}).tooltip: tooltip was updated to ${this.tooltip}.`);
        }
        catch (e) {
            if (e instanceof viewer_shared_services_1.ShapeDiverViewerError || e instanceof viewer_shared_services_1.ShapeDiverBackendError)
                throw e;
            throw __classPrivateFieldGet(this, _Parameter_logger, "f").handleError(viewer_shared_services_1.LOGGINGTOPIC.PARAMETER, `Parameter(${this.id}).tooltip`, e);
        }
    }
    get type() {
    ...
    set value(value) {
        try {
            ...
            if (this.isValid(value, true)) {
                ...
                __classPrivateFieldGet(this, _Parameter_logger, "f").debug(viewer_shared_services_1.LOGGINGTOPIC.PARAMETER, `Parameter(${__classPrivateFieldGet(this, _Parameter_id, "f")}).value: Value was updated to ${this.value}.`);
                ...
                const error = new viewer_shared_services_1.ShapeDiverViewerSessionError(`Parameter(${__classPrivateFieldGet(this, _Parameter_id, "f")}).value: Could not validate value.`);
                throw __classPrivateFieldGet(this, _Parameter_logger, "f").handleError(viewer_shared_services_1.LOGGINGTOPIC.PARAMETER, `Parameter(${this.id}).value`, error);
            }
        }
        catch (e) {
            if (e instanceof viewer_shared_services_1.ShapeDiverViewerError || e instanceof viewer_shared_services_1.ShapeDiverBackendError)
                throw e;
            throw __classPrivateFieldGet(this, _Parameter_logger, "f").handleError(viewer_shared_services_1.LOGGINGTOPIC.PARAMETER, `Parameter(${this.id}).value`, e);
        }
    }
    get visualization() {
    ...
    isValid(value, throwError = false) {
        try {
                    ...
                    case this.type === PARAMETERTYPE.BOOL:
                        if (typeof value === 'string') {
                            if (!(value === 'true' || value === 'false')) {
                                ...
                                throw __classPrivateFieldGet(this, _Parameter_logger, "f").handleError(viewer_shared_services_1.LOGGINGTOPIC.PARAMETER, `Parameter(${this.id}).value`, error, false);
                            }
                        }
                        else {
            ...
            if (e instanceof viewer_shared_services_1.ShapeDiverViewerError || e instanceof viewer_shared_services_1.ShapeDiverBackendError)
                throw e;
            throw __classPrivateFieldGet(this, _Parameter_logger, "f").handleError(viewer_shared_services_1.LOGGINGTOPIC.PARAMETER, `Parameter(${this.id}).isValid`, e);
        }
    }
    resetToDefaultValue() {
        try {
            ...
            __classPrivateFieldSet(this, _Parameter_value, __classPrivateFieldGet(this, _Parameter_defaultValue, "f"), "f");
            __classPrivateFieldGet(this, _Parameter_logger, "f").debug(viewer_shared_services_1.LOGGINGTOPIC.PARAMETER, `Parameter(${__classPrivateFieldGet(this, _Parameter_id, "f")}).resetToDefaultValue: value was set to default value ${__classPrivateFieldGet(this, _Parameter_defaultValue, "f")}.`);
        }
        catch (e) {
            if (e instanceof viewer_shared_services_1.ShapeDiverViewerError || e instanceof viewer_shared_services_1.ShapeDiverBackendError)
                throw e;
            throw __classPrivateFieldGet(this, _Parameter_logger, "f").handleError(viewer_shared_services_1.LOGGINGTOPIC.PARAMETER, `Parameter(${this.id}).resetToDefaultValue`, e);
        }
    }
    resetToSessionValue() {
        try {
            ...
            __classPrivateFieldGet(this, _Parameter_logger, "f").debug(viewer_shared_services_1.LOGGINGTOPIC.PARAMETER, `Parameter(${__classPrivateFieldGet(this, _Parameter_id, "f")}).resetToSessionValue: value was set to last session value ${this.sessionValue}.`);
        }
        catch (e) {
            if (e instanceof viewer_shared_services_1.ShapeDiverViewerError || e instanceof viewer_shared_services_1.ShapeDiverBackendError)
                throw e;
            throw __classPrivateFieldGet(this, _Parameter_logger, "f").handleError(viewer_shared_services_1.LOGGINGTOPIC.PARAMETER, `Parameter(${this.id}).resetToSessionValue`, e);
        }
    }
    stringify() {
        try {
            ...
            if (e instanceof viewer_shared_services_1.ShapeDiverViewerError || e instanceof viewer_shared_services_1.ShapeDiverBackendError)
                throw e;
            throw __classPrivateFieldGet(this, _Parameter_logger, "f").handleError(viewer_shared_services_1.LOGGINGTOPIC.PARAMETER, `Parameter(${this.id}).stringify`, e);
        }
    }
}
