...
class SDTFEngine {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            for (let i = 0; i < this._parsedFile.attributes.length; i++) {
                ...
                for (let key in attributes.entries) {
                    ...
                    const dataTypehint = dataToCopy.typeHint === undefined
                        ? "undefined"
    ...
    loadAttributes(attributes) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            for (let key in attributes.entries) {
                if (sdk_sdtf_primitives_1.SdtfPrimitiveTypeGuard.isBooleanType((_a = attributes.entries[key].typeHint) === null || _a === void 0 ? void 0 : _a.name) ||
                    sdk_sdtf_primitives_1.SdtfPrimitiveTypeGuard.isColorType((_b = attributes.entries[key].typeHint) === null || _b === void 0 ? void 0 : _b.name) ||
                    sdk_sdtf_primitives_1.SdtfPrimitiveTypeGuard.isNumberType((_c = attributes.entries[key].typeHint) === null || _c === void 0 ? void 0 : _c.name) ||
                    sdk_sdtf_primitives_1.SdtfPrimitiveTypeGuard.isStringType((_d = attributes.entries[key].typeHint) === null || _d === void 0 ? void 0 : _d.name)) {
