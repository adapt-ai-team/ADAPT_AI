...
class PrimitiveData {
     ...
     */
    constructor(attributes = {}, mode = PRIMITIVE_MODE.TRIANGLES, indices = null, material = null, attributeMaterial = null) {
        // #region Properties (5)
...
class GeometryData extends viewer_shared_node_tree_1.AbstractTreeNodeData {
     ...
     * @param id the id
     */
    constructor(primitive, matrix = gl_matrix_1.mat4.create(), id, morphWeights = [], bones = [], boneInverses = []) {
        super(id);
        // #region Properties (4)
        ...
        _GeometryData_bones.set(this, []);
        _GeometryData_boneInverses.set(this, []);
        ...
        __classPrivateFieldSet(this, _GeometryData_bones, bones, "f");
        __classPrivateFieldSet(this, _GeometryData_boneInverses, boneInverses, "f");
    }
    // #endregion Constructors (1)
    ...
    get bones() {
        return __classPrivateFieldGet(this, _GeometryData_bones, "f");
    }
    set bones(value) {
        __classPrivateFieldSet(this, _GeometryData_bones, value, "f");
    }
    get boneInverses() {
        return __classPrivateFieldGet(this, _GeometryData_boneInverses, "f");
    }
    set boneInverses(value) {
        __classPrivateFieldSet(this, _GeometryData_boneInverses, value, "f");
    }
     ...
     */
    clone() {
        return new GeometryData(__classPrivateFieldGet(this, _GeometryData_primitive, "f").clone(), gl_matrix_1.mat4.clone(this.matrix), this.id, __classPrivateFieldGet(this, _GeometryData_morphWeights, "f"), __classPrivateFieldGet(this, _GeometryData_bones, "f"), __classPrivateFieldGet(this, _GeometryData_boneInverses, "f"));
    }
...
_GeometryData_matrix = new WeakMap(), _GeometryData_primitive = new WeakMap(), _GeometryData_boundingBox = new WeakMap(), _GeometryData_renderOrder = new WeakMap(), _GeometryData_morphWeights = new WeakMap(), _GeometryData_bones = new WeakMap(), _GeometryData_boneInverses = new WeakMap();
