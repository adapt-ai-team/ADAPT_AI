...
const MaterialUnlitData_1 = require("../material/MaterialUnlitData");
...
const grayscaleVisualization = (factor) => {
    ...
    return {
        material: new MaterialUnlitData_1.MaterialUnlitData({ color: 'rgb(' + color + ', ' + color + ', ' + color + ')', opacity: 1 }),
        matrix: gl_matrix_1.mat4.create()
    };
};
const opacityVisualization = (factor, defaultMaterial) => {
    return {
        material: new MaterialUnlitData_1.MaterialUnlitData({ color: (defaultMaterial === null || defaultMaterial === void 0 ? void 0 : defaultMaterial.color) || '#00fff7', opacity: factor }),
        matrix: gl_matrix_1.mat4.create()
    };
};
const blueRedVisualization = (factor) => {
    ...
    return {
        material: new MaterialUnlitData_1.MaterialUnlitData({ color: 'rgb(' + Math.floor(red) + ', ' + Math.floor(0) + ', ' + Math.floor(blue) + ')', opacity: 1 }),
        matrix: gl_matrix_1.mat4.create()
    };
};
const blueWhiteRedVisualization = (factor) => {
    ...
    return {
        material: new MaterialUnlitData_1.MaterialUnlitData({ color: 'rgb(' + Math.floor(red) + ', ' + Math.floor(green) + ', ' + Math.floor(blue) + ')', opacity: 1 }),
        matrix: gl_matrix_1.mat4.create()
    };
};
const greenRedVisualization = (factor) => {
    ...
    return {
        material: new MaterialUnlitData_1.MaterialUnlitData({ color: 'rgb(' + Math.floor(red) + ', ' + Math.floor(green) + ', ' + Math.floor(0) + ')', opacity: 1 }),
        matrix: gl_matrix_1.mat4.create()
    };
};
...
const hslVisualization = (factor) => {
    ...
    return {
        material: new MaterialUnlitData_1.MaterialUnlitData({ color: 'hsl(' + Math.floor(hue) + ', 100%, 50%)', opacity: 1 }),
        matrix: gl_matrix_1.mat4.create()
    };
};
